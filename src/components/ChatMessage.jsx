...
const ChatMessage = ({ chat }) => {
  ...
  const messageText = typeof chat?.text === 'string' 
    ? (messageType === 'user' ? chat.text.replace(/\n/g, ' ') : chat.text) 
  ...
  return (
    ...
    >
      ...
      <div className="message-content">
        <p className={`message-text ${messageType === 'model' ? 'bot-message-text' : 'user-message-text'}`}>
          {isThinking ? (
